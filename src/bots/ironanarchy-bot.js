...
async function initBot() {
  ...
  let autoEatModule
  try {
    autoEatModule = await import('mineflayer-auto-eat')
    console.log('✅ Successfully imported mineflayer-auto-eat as ES Module')
  } catch (error) {
    console.error('❌ Failed to import mineflayer-auto-eat:', error.message)
    process.exit(1)
  }
  ...
  // Auto-eat plugin - handle ES Module exports
  const autoEat = autoEatModule.default || autoEatModule.loader || autoEatModule
