...
console.log('🔥 Iron-Anarchy Connection Test (Online Auth) Starting...')
...
bot.on('spawn', () => {
  ...
  setTimeout(() => {
    bot.chat('🔥 Connection test bot online (Microsoft auth)!')
  }, 2000)
})
...
console.log('Bot configured with Microsoft authentication, attempting connection...')
